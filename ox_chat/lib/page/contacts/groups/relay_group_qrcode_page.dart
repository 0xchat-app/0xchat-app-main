...
class RelayGroupQrcodePage extends StatefulWidget {

  final String groupId;

  RelayGroupQrcodePage({required this.groupId});

  @override
  State<StatefulWidget> createState() {
    return _RelayGroupQrcodePageState();
  }
}

class _RelayGroupQrcodePageState extends State<RelayGroupQrcodePage> {
  String _imgUrl = '';
