...
enum StorageSettingKey {
  ...
  KEY_IS_ORIGINAL_PASSPHRASE(1008, 'KEY_IS_ORIGINAL_PASSPHRASE'), // waiting delete
  KEY_CHAT_IMPORT_DB(1009, 'KEY_CHAT_IMPORT_DB'),
  KEY_IS_CHANGE_DEFAULT_DB_PW(1010, 'KEY_IS_CHANGE_DEFAULT_DB_PW'),// waiting delete
  ...
  KEY_THEME_INDEX(1018, 'KEY_THEME_INDEX'),
  KEY_OPEN_P2P(1019, 'KEY_OPEN_P2P'),
  KEY_IS_SHOW_WALLET_SELECTOR(1020, 'KEY_IS_SHOW_WALLET_SELECTOR'),
  KEY_DEFAULT_WALLET(1021, 'KEY_DEFAULT_WALLET'),
  KEY_ICE_SERVER(1022, 'KEY_ICE_SERVER'),
  KEY_FILE_STORAGE_SERVER(1023, 'KEY_FILE_STORAGE_SERVER'),
  KEY_FILE_STORAGE_SERVER_INDEX(1024, 'KEY_FILE_STORAGE_SERVER_INDEX');
