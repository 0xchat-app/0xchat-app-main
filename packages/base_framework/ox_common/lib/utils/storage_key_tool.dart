...
class StorageKeyTool {
  ...
  static const String KEY_SIGNER_PACKAGE_NAME = "KEY_SIGNER_PACKAGE_NAME";
...
enum StorageSettingKey {
  ...
  KEY_TRANSLATE_SERVICE(1027, 'KEY_TRANSLATE_SERVICE'),
  KEY_TRANSLATE_SERVER(1028, 'KEY_TRANSLATE_SERVER'),
  KEY_TRANSLATE_URL(1029, 'KEY_TRANSLATE_URL'),
  KEY_TRANSLATE_API_KEY(1030, 'KEY_TRANSLATE_API_KEY'),
  KEY_AUTO_TRANSLATE_NOTES(1031, 'KEY_AUTO_TRANSLATE_NOTES'),
  KEY_VIDEO_PLAYBACK_VOLUME(1032, 'KEY_VIDEO_PLAYBACK_VOLUME');
